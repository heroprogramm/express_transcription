...
const base =
  "font-ui font-semibold cursor-pointer inline-flex items-center justify-center transition-all disabled:opacity-25 disabled:cursor-not-allowed disabled:pointer-events-none";
