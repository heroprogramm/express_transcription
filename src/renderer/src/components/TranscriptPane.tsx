  ...
  return (
    <div class="flex flex-col items-center justify-center h-full -mt-12 gap-4">
      <div class="flex items-end gap-[3px] h-8">
        {[0.6, 0.3, 0.8, 0.5, 1, 0.4, 0.7, 0.3, 0.9, 0.5, 0.6, 0.4].map((h, i) => (
          <div
            class="waveform-bar w-[3px] rounded-full bg-amber/20"
            style={{
              height: `${h * 100}%`,
...
export function SpeechPane(props: SpeechPaneProps) {
  ...
  return (
    <section class="pane-amber flex-1 flex flex-col min-w-0 bg-raised border border-border rounded-xl overflow-hidden relative">
      <div class="flex justify-between items-center px-4 py-2.5 border-b border-border shrink-0">
        <div class="flex items-center gap-2">
          <span class="w-[6px] h-[6px] rounded-full bg-amber shrink-0 shadow-[0_0_8px_var(--amber-glow)]" />
...
export function TranslationPane(props: TransPaneProps) {
  ...
  return (
    <section class="pane-teal flex-1 flex flex-col min-w-0 bg-raised border border-border rounded-xl overflow-hidden relative">
      <div class="flex justify-between items-center px-4 py-2.5 border-b border-border shrink-0">
        <div class="flex items-center gap-2">
          <span class="w-[6px] h-[6px] rounded-full bg-teal shrink-0 shadow-[0_0_8px_var(--teal-glow)]" />
